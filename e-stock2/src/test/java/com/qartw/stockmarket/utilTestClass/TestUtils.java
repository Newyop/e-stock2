package com.qartw.stockmarket.utilTestClass;
...
public class TestUtils {
	...
	static {
		...
		failed = 0;
		testResult="";
		xmlFile = new File("./Stock-Market.xml");
		xmlFile.delete();
	...
	public static void testAssert(String testName, Object result, File file) throws IOException {
		total++;
